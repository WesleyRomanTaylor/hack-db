...
//
// TODO: Extend the HackDb service by defining new RPCs and
...
//
// TODO: Create an implementation of the HackDb server
...
// implementation of HackDb server interface service, but only
...
// Default implementation of the HackDb server interface
...
func NewBasicServer(database *gorm.DB) (pb.HackDbServer, error) {
